...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // UINavigationBar.appearance().backgroundColor = UIColor(white: 223, alpha: 1)
        ...
        statusBarBackroundView.backgroundColor = UIColor.red

        window?.addSubview(statusBarBackroundView)
        window?.addConstraints(withVisualFormat: "H:|[v0]|", views: statusBarBackroundView)
        window?.addConstraints(withVisualFormat: "V:|[v0(30)]", views: statusBarBackroundView)
